...
Label_hospital.place(relx=0.2,rely=0.35,anchor=CENTER)

Label_IT=Label(root)
Label_IT.place(relx=0.2,rely=0.65,anchor=CENTER)

Label_chemical=Label(root)
Label_chemical.place(relx=0.2,rely=0.95,anchor=CENTER)
